export const experiments = [
  {
    ...
    date: 2014,
    description:
      "<p>Cloujera lets you do a fine-grained search for spoken words in Coursera's videos. We built " +
  ...
  },
  {
    ...
    date: 2014,
    description:
      '<p>Developed a personal cloud for the smart driving Android app ' +
    ...
    links: [
      {
        type: 'demo',
        link:
          'https://play.google.com/store/apps/details?id=com.ecoshifter.beta'
      }
    ]
  },
  {
    ...
    date: 2013,
    description:
      '<p>My personal website. I really liked the concept of static websites for small projects after ' +
  ...
  },
  {
    ...
    date: 2013,
    description:
      '<p>Web application developed as part as a masters dissertation studying the impact of adaptive user ' +
    ...
    links: [
      ...
      },
      {
        type: 'paper',
        link:
          'http://www.localisation.ie/news/archive/information/localisation-focus-volume-12-issue-1-available-free-download%C2%A073mb'
      }
    ]
  },
  {
    ...
    date: 2013,
    description:
      '<p>Research project that analyzes the feasibility of implementing live video streaming ' +
    ...
    teamSize: 3,
    technologies:
      'WebRTC, peer.js, jQuery, HTML5/CSS, Bootstrap, Google AppLayout Engine',
    links: [
      {
        type: 'demo',
      ...
      },
      {
        type: 'paper',
        link:
          'http://ieeexplore.ieee.org/xpl/articleDetails.jsp?tp=&arnumber=6916588&queryText%3Dwebrtc+p2p'
      }
    ]
  },
  {
    ...
    date: 2012,
    description:
      '<p>Platform based on a mobile app, a web service and a web app that provides restaurants with the ' +
    ...
    teamSize: 4,
    technologies:
      'Python, Django REST Framework, PostgreSQL, jQuery, Android SDK, Amazon EC2'
  },
  {
    id: 4,
    name: 'Improve',
    date: 2012,
    description:
      '<p>A simple Facebook app that leverage the information provided by the Facebook Graph API to help ' +
    ...
    teamSize: 4,
    technologies:
      'Python, JavaScript, Graph API, GAE, App Engine Datastore, Git',
    links: [
      {
        type: 'demo',
  ...
  },
  {
    ...
    date: 2012,
    description:
      '<p>Academic project which involved the design and implementation of a scalable distributed booking ' +
  ...
  },
  {
    ...
    date: 2011,
    description:
      '<p>Platform based on a mobile app and a REST web service that provides real ' +
  ...
  },
  {
    ...
    date: 2011,
    description:
      '<p>A videogame based on the arcade game Frogger developed together with some friends. ' +
